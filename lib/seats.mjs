 ...
 *   - CDP on → new tab seat.
 *
 * Occupied desks do not require a ChatGPT cookie probe. On main/#10 that
 * probe could fail and hand the second user mode:"vnc" instead of a tab.
 */
export function decideOpenMode({ occupants = [], userId, tabCount = 0, cap = DEFAULT_TAB_SEAT_CAP, existing, cdp = false } = {}) {
