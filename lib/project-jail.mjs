...
export function projectJailHideCss(home) {
  ...
  return [
    `[data-gpc-hidden-project="1"],[data-gpc-hidden-project="1"] *{display:none!important;visibility:hidden!important;pointer-events:none!important;height:0!important;max-height:0!important;margin:0!important;padding:0!important;overflow:hidden!important;border:none!important}`,
    `${other}{display:none!important;visibility:hidden!important;pointer-events:none!important}`,
    `li:has(${other}),[role="listitem"]:has(${other}),[role="menuitem"]:has(${other}),[role="option"]:has(${other}),[role="treeitem"]:has(${other}),[role="row"]:has(${other}){display:none!important;visibility:hidden!important;height:0!important;max-height:0!important;overflow:hidden!important;margin:0!important;padding:0!important;pointer-events:none!important}`,
  ].join("");
}
...
export function projectJailScript(home) {
  ...
  return `(() => {
    ...
    const ensureCss = () => {
      if (document.getElementById("gpc-project-jail-css")) return;
      const style = document.createElement("style");
      style.id = "gpc-project-jail-css";
      style.setAttribute("data-gpc-project-jail", "1");
    ...
    const hideOther = (root) => {
      ...
      if (root && root.matches?.(`${CONTROL}, ${PROJECT_HREF}`) && isOther(hrefOf(root))) hide(root);
    };
