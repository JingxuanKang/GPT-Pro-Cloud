...
describe("standalone product", () => {
  ...
  it("gateway is the only entry", () => {
    ...
    assert.match(chromeBar, /grid-template-columns: 1fr auto 1fr/);
    assert.match(chromeBar, /align-items: center/);
    assert.match(chromeBar, /height: 52px/);
    assert.match(chromeBar, /line-height: 1/);
